...
SECRET_KEY = 'django-insecure-9##kx6m&175xe6e3jvro5aqdc$lyoe$!j3v&q-vtbrzyycuob&'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'db.context_processors.versioned_static',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_web',       # Nama database MySQL yang telah Anda buat
